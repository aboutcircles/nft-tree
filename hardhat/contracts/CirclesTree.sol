...
contract CirclesTree is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    string private constant baseURI = "ipfs://QmRBUZdX2ZCydjg88XvFiyDkR9GfCv17oau7wJPZ2ExvYP";
    ...
    return string(abi.encodePacked(
        ...
        Base64.encode(
            abi.encodePacked(
                "{",
                '"name": "Token of Appreciation Circles NFT#', tokenId.toString(), '",',
                '"description": "Minted during Devcon Week for donating Circles on Gnosis Chain",',
                '"image": "', baseURI, '"',
                "}"
            )
        )
