...
export default function Donation({ address, imageUrl, username, crcAmount }: Donor) {
  return (
    <Link className="w-full flex justify-between items-center border lg:border-b-0 lg:last:border-b border-slate-300 p-2 lg:p-4 gap-x-2 hover:cursor-pointer" href={"https://circles.garden/profile/" + address} target="_blank">
      ...
      <p className="text-[10px] portrait:lg:text-2xl ml-2">{username ? username : truncateAddress(address)}</p>
