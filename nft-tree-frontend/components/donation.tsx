...
// export type DonationProps = Donor & {
//   isCurrent: boolean;
// };
...
export default function Donation({
  ...
  return (
    // <Link
    //   className="w-full flex justify-between items-center border-t border-l border-r border-b lg:border-b-0 lg:last:border-b border-slate-300 p-2 lg:p-2 hover:cursor-pointer"
    ...
    <div className="w-full flex justify-between items-center border lg:border-b-0 lg:last:border-b border-slate-300 p-2 lg:p-4 hover:cursor-pointer">
      {imageUrl ? (
        <Image
          ...
          height={25}
          objectFit="cover"
          className="border-white border w-6 h-6 lg:w-8 lg:h-8"
        />
      ) : (
        <div className="border-white text-white flex items-center justify-center text-lg border w-6 h-6 lg:w-8 lg:h-8">
          ?
        </div>
      )}
