...
export default function Donation({
  ...
  return (
    <div className="w-full flex items-center border lg:border-b-0 lg:last:border-b border-slate-300 p-2 lg:p-4 hover:cursor-pointer portrait:min-w-[280px] landscape:7xl:min-w-[300px] lg:w-[250px]">
      {imageUrl ? (
        <Image
          src={imageUrl}
          alt={""}
