      ...
      <div className="w-full flex flex-col p-2 lg:p-4">
        <div className="w-full flex justify-between">
          <div className="flex flex-col gap-y-1">
            <p className="text-[10px] lg:text-[14px] portrait:lg:text-3xl text-white/50">MINTED BY</p>
            <p className="text-[8px] lg:text-[16px] portrait:lg:text-2xl">{username ? username : truncateAddress(address)}</p>
          </div>
        ...
        <p className="text-[10px] lg:text-[14px] portrait:lg:text-3xl text-white/50 mt-2">MINTED ON</p>
        <p className="text-[8px] lg:text-[16px] portrait:lg:text-2xl mt-1">{new Date(Number(timestamp) * 1000).toDateString()}</p>
      </div>
    </Link>
  );
}
