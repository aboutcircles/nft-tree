...
export default function CirclesInfo() {
  ...
  return (
    <div className="flex justify-start md:justify-between gap-x-4 items-center portrait:w-screen lanscape:w-full md:w-full portrait:md:items-end border-2 landscape:border-0 md:border-0 landscape:flex-col md:flex-col portrait:md:flex-col-reverse landscape:items-start p-2 md:p-0">
      <div className="w-12 h-12 bg-[url('/nftIcon.gif')] bg-cover bg-center landscape:w-28 landscape:h-28 landscape:lg:w-[180px] landscape:lg:h-[180px] portrait:lg:w-[240px] portrait:lg:h-[240px] landscape:md:w-[180px] landscape:md:h-[180px] portrait:md:w-[180px] portrait:md:h-[180px] border-2 lg:mt-2">
        {/* <CirclesIcon /> */}
      </div>
