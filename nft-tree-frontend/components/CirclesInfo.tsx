...
export default function CirclesInfo({ supply }: CirclesInfoProps) {
  return (
    <div className="flex flex justify-between items-center w-screen lg:w-full portrait:lg:items-end border-2 lg:border-0 lg:flex-col portrait:lg:flex-col-reverse landscape:items-start p-2 lg:p-0">
